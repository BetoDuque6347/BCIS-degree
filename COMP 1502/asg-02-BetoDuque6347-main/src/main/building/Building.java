...
public class Building {
    ...
    public void add(Die die, int row, int col) {
    ...
    public void add(DiceStack stack, int row, int col) {
        // adjust for base-0 indexing
        row--;
        col--;
    ...
    public Die getDie(int row, int col, int level) {
        // adjust for base-0 indexing
        row--;
        col--;
        level--;
    ...
    public DiceStack[][] getStack(int row, int col) {
        return building;
    }
