...
public class Blueprint {
    ...
    public boolean isOpenSpace(int row, int col) {
        int coordinate = findCoordinate(row, col);
    ...
    public boolean isProhibitedSpace(int row, int col) {
        if (!isOpenSpace(row, col)) {
            return true;
        }
    ...
    public int heightTargetAt(int row, int col) {
        int coordinate = findCoordinate(row, col);
        int targetHeight = 0;
    ...
    public int findCoordinate(int row, int col) {
        //Adjut for base-0 indexing
        row--;
        col--;
